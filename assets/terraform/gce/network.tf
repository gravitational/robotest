...
resource "google_compute_firewall" "robotest" {
  ...
  allow {
    ...
    ports = ["22", "61822", "32009", "61008-61010", "61022-61024", "3008-3010", "6060", "4242",
      "10248",
      "10250",
      "7496",
      "7373",
...
# TODO: with FW rules for individual use-case, robotest runs into quota restriction pretty fast
