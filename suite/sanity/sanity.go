...
var Basic = map[string]gravity.TestFunc{
	...
	"install_2_1": installInCycles(cycleInstallParam{
		Cycles: 2, Flavors: map[uint]string{1: "one"}, Timeouts: defaultTimeouts, Role: "node", ParallelCycles: true}),
	...
	"install_10_3": installInCycles(cycleInstallParam{
		Cycles: 10, Flavors: map[uint]string{3: "three"}, Timeouts: defaultTimeouts, Role: "node", ParallelCycles: true}),
	...
	"install_1_136": installInCycles(cycleInstallParam{
		...
		Timeouts: defaultTimeouts, Role: "node", ParallelCycles: true, ParallelFlavors: true}),
